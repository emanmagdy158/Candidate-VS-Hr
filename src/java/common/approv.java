    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String q = "SELECT * FROM candidate.chosansr where cid = '"+cid+"' ";
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet approv</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet approv at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
